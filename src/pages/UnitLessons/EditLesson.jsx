...
function EditLesson({ getFunction, openModal, setOpenModal,rowData,setRowData }) {
  console.log(rowData)
...
const {id} = useParams()
  const saveNewUnit = async(e) => {
    ...
    axios.post(docUrl+"/home/q_bank/update_lesson.php",JSON.stringify(data_send))
    .then((res)=>{
      console.log(res)
      ...
      <form onSubmit={(e) => saveNewUnit(e)} className="animated-form">
        <div className="form-group">
          ...
          <input
            ...
            value={rowData?.lesson_name}
            onChange={(e) => setRowData({ ...rowData, lesson_name: e.target.value })}
