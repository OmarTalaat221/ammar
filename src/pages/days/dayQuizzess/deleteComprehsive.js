  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "https://camp-coding.online/Teacher_App_2024/Mahmoud_Ammar/doctor/home/delete_question_attachment.php",
        {
          method: "POST",
          headers: {
      ...
      // console.error("Error deleting quesytion:", error);
      // Toast.show({
      //   text: "An error occurred while deleting the question.",
      //   buttonText: "Retry",
      //   type: "danger",
      ...
      <div className="delete-confirmation">
        ...
        <div className="modal-actions">
          <button
            ...
            className="confirm-btn btn btn-danger"
            disabled={loading}
          >
