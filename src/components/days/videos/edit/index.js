...
function EditVideo({ getFunction, openModal, setOpenModal ,toast , setToast
 }) {
  ...
  const saveUpdatedVideo = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://camp-coding.online/Teacher_App_2024/Mahmoud_Ammar/doctor/home/edit_video_data.php",
        dataToSend
      );
